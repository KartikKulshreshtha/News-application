...
export class News extends Component {
    articles = [
        ...
        },
        {
            ...
            "author": null,
            "title": "FRIDAY BRIEFING | Under the pump: Cricket’s reckoning with race and history",
            "description": "The gentlemen’s game, as cricket is lovingly referred to, is going through turbulent times in South Africa.",
            ...
            <div className='container my-3'>
                ...
                <div className="row">
                    <div className="col-md-4">
                        <NewsItem title="News Item 1" description="description of news item 1" imageUrl="https://cdn.24.co.za/files/Cms/General/d/2670/40fa292097db4c18aeafcb7b29aefc82.jpg"/>
                    </div>
                    <div className="col-md-4">
