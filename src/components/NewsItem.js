...
export class NewsItem extends Component {
    render() {
        ...
        return (
            <div>
                <div className="card" style={{ backgroundColor: 'rgb(46 56 76)', color: "#fff"}}> <span className="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style={{left: "90%", zIndex:"1"}}>
                    {source}</span>
